...
const Input = ({ placeholder, name, type, value, handlaChange }) => (
  <input
    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12  px-4">
        <div className="flex flex-1 justify-start  flex-col mf: mr-10">
          ...
          <p className="text-left mt-5 text-white font-light md md:w-9/12 w-11/12 text-base">
          ...
          <button
            ...
            className="flex flex-row justify-center items -center  my-5 bg-[#2952e3] p-3 rounded-full cusor-pointer  hover:bg-[#2546bd"
          >
            ...
            <div className="h-[1px] w-full bg-gray-400 my-2">
              {false ? (
                ...
                <button
                  ...
                  className="text-white w-full mt-2 border-[1px] p-2 border-[#3d4f7c] rounded-full cusor-pointer"
                >
                  Send Now
                </button>
              )}
